const CACHE = "deal-board-v11";
const SHELL = ["./", "index.html", "directory.js", "directory2.js", "manifest.webmanifest", "icon.svg", "icon-192.png"];
...
self.addEventListener("fetch", e => {
  ...
  const fresh = e.request.mode === "navigate" || /(index\.html|sw\.js|version\.txt|directory2?\.js)$/.test(url.pathname);
