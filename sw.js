const CACHE = "deal-board-v15";
const SHELL = ["./", "index.html", "app.css", "ui.js", "directory.js", "directory2.js", "today.js", "kitdata.js", "dealkit.js", "manifest.webmanifest", "icon.svg", "icon-192.png"];
...
self.addEventListener("fetch", e => {
  ...
  const fresh = e.request.mode === "navigate" || /(index\.html|sw\.js|version\.txt|directory2?\.js|today\.js|kitdata\.js|dealkit\.js|app\.css|ui\.js)$/.test(url.pathname);
